...
import { MAIN, LOG, PROF, ABOUT, Allowance, Attendance, Discs, Sch, SCORE, Teachs, ProfScorE, RaspPROF, Dopusk, BOT, AtProf} from "../../utils/consts";
  ...
  ...(user.isAuth
    ? user.isProf
      ? [ 
          ...
          { title: "Посещаемость", path: AtProf },
